...
const CITY_MAPPINGS: Array<[string, string, string, string, string, number]> = [
  // === MAINE ===
  ['Portland', 'ME', '23005', '0100', 'R1X', 1],   // Portland-South Portland CBSA not primary → NE regional
  ['Lewiston', 'ME', '23001', '0100', 'R1X', 1],   // No CBSA match → Northeast regional
  ['Bangor', 'ME', '23019', '0100', 'R1X', 1],
  ['South Portland', 'ME', '23005', '0100', 'R1X', 1],
  ['Auburn', 'ME', '23001', '0100', 'R1X', 1],

  // === NEW HAMPSHIRE ===
  ['Manchester', 'NH', '33011', '0100', 'R1X', 3],  // Manchester-Nashua CBSA not primary → NE regional
  ['Nashua', 'NH', '33011', '0100', 'R1X', 3],
  ...
  ['Worcester', 'MA', '25027', '0100', 'SMA', 2],   // Worcester CBSA not primary → NE regional, MA state gas
  ['Springfield', 'MA', '25013', '0100', 'SMA', 2], // Springfield CBSA not primary → NE regional, MA state gas
  ['Cambridge', 'MA', '25017', 'S11A', 'YBOS', 1],
  ['Lowell', 'MA', '25017', 'S11A', 'YBOS', 1],

  // === RHODE ISLAND ===
  ['Providence', 'RI', '44007', '0100', 'R1X', 3],  // Providence CBSA not primary → NE regional
  ['Cranston', 'RI', '44007', '0100', 'R1X', 3],
  ['Warwick', 'RI', '44003', '0100', 'R1X', 3],
  ['Pawtucket', 'RI', '44007', '0100', 'R1X', 3],
  ['East Providence', 'RI', '44007', '0100', 'R1X', 3],

  // === CONNECTICUT ===
  ['Bridgeport', 'CT', '09001', '0100', 'R1X', 3],  // Bridgeport CBSA not primary → NE regional
  ['New Haven', 'CT', '09009', '0100', 'R1X', 3],    // No CBSA match → Northeast regional
  ['Hartford', 'CT', '09003', '0100', 'R1X', 3],     // Hartford CBSA not primary → NE regional
  ['Stamford', 'CT', '09001', '0100', 'R1X', 3],
  ['Waterbury', 'CT', '09009', '0100', 'R1X', 3],

  // === NEW YORK ===
  ['New York City', 'NY', '36061', 'S12A', 'Y35NY', 1],
  ['Buffalo', 'NY', '36029', '0100', 'SNY', 1],     // Buffalo CBSA not primary → NE regional, county gas override → NY state
  ...
  ['Pittsburgh', 'PA', '42003', '0100', 'R1Y', 3],  // Pittsburgh CBSA not primary → NE regional
  ['Allentown', 'PA', '42077', '0100', 'R1Y', 3],   // Allentown CBSA not primary → NE regional
  ['Reading', 'PA', '42011', '0100', 'R1Y', 3],     // Reading CBSA not primary → NE regional
  ...
  // === NORTH CAROLINA ===
  ['Charlotte', 'NC', '37119', '0300', 'R1Z', 3],   // Charlotte CBSA not primary → South regional
  ['Raleigh', 'NC', '37183', '0300', 'R1Z', 3],     // Raleigh CBSA not primary → South regional
  ...
  ['Greenville', 'SC', '45045', '0300', 'R1Z', 3],  // Greenville CBSA not primary → South regional
  ...
  // === FLORIDA ===
  ['Jacksonville', 'FL', '12031', '0300', 'SFL', 1], // Jacksonville CBSA not primary → South regional, county gas override → FL state
  ['Miami', 'FL', '12086', 'S35B', 'YMIA', 1],
  ['Tampa', 'FL', '12057', 'S35D', 'SFL', 2],
  ['Orlando', 'FL', '12095', '0300', 'SFL', 1],     // Orlando CBSA not primary → South regional, county gas override → FL state
  ...
  ['Southaven', 'MS', '28033', '0300', 'R30', 3],   // Memphis CBSA not primary → South regional
  ['Hattiesburg', 'MS', '28035', '0300', 'R30', 3],
  ['Biloxi', 'MS', '28047', '0300', 'R30', 3],

  // === TENNESSEE ===
  ['Nashville', 'TN', '47037', '0300', 'R20', 3],   // Nashville CBSA not primary → South regional
  ['Memphis', 'TN', '47157', '0300', 'R20', 3],     // Memphis CBSA not primary → South regional
  ['Knoxville', 'TN', '47093', '0300', 'R20', 3],   // Knoxville CBSA not primary → South regional
  ['Chattanooga', 'TN', '47065', '0300', 'R20', 3], // Chattanooga CBSA not primary → South regional
  ['Clarksville', 'TN', '47125', '0300', 'R20', 3],

  // === KENTUCKY ===
  ['Louisville', 'KY', '21111', '0300', 'R20', 3],  // Louisville CBSA not primary → South regional
  ['Lexington', 'KY', '21067', '0300', 'R20', 3],   // Lexington CBSA not primary → South regional
  ['Bowling Green', 'KY', '21227', '0300', 'R20', 3],
  ['Owensboro', 'KY', '21059', '0300', 'R20', 3],
  ['Covington', 'KY', '21117', '0300', 'R20', 3],   // Cincinnati CBSA not primary → South regional
  ...
  // === OHIO ===
  ['Columbus', 'OH', '39049', '0200', 'SOH', 2],    // Columbus CBSA not primary → Midwest regional
  ['Cleveland', 'OH', '39035', '0200', 'YCLE', 1],  // Cleveland CBSA not primary → Midwest regional, county gas override → Cleveland
  ['Cincinnati', 'OH', '39061', '0200', 'SOH', 2],  // Cincinnati CBSA not primary → Midwest regional
  ['Toledo', 'OH', '39095', '0200', 'SOH', 2],
  ['Akron', 'OH', '39153', '0200', 'SOH', 2],

  // === MICHIGAN ===
  ['Detroit', 'MI', '26163', 'S23B', 'R20', 3],     // CBSA → Detroit-Warren-Dearborn
  ['Grand Rapids', 'MI', '26081', '0200', 'R20', 1], // Grand Rapids CBSA not primary → Midwest regional
  ['Warren', 'MI', '26099', 'S23B', 'R20', 3],
  ['Sterling Heights', 'MI', '26099', 'S23B', 'R20', 3],
  ['Ann Arbor', 'MI', '26161', '0200', 'R20', 3],   // Ann Arbor CBSA not primary → Midwest regional

  // === INDIANA ===
  ['Indianapolis', 'IN', '18097', '0200', 'R20', 1], // Indianapolis CBSA not primary → Midwest regional
  ['Fort Wayne', 'IN', '18003', '0200', 'R20', 3],
  ['Evansville', 'IN', '18163', '0200', 'R20', 3],
  ['South Bend', 'IN', '18141', '0200', 'R20', 3],
  ['Carmel', 'IN', '18057', '0200', 'R20', 1],      // Indianapolis CBSA not primary → Midwest regional
  ...
  ['Rockford', 'IL', '17201', '0200', 'R20', 3],    // Rockford CBSA not primary → Midwest regional

  // === WISCONSIN ===
  ['Milwaukee', 'WI', '55079', '0200', 'R20', 3],   // Milwaukee CBSA not primary → Midwest regional
  ['Madison', 'WI', '55025', '0200', 'R20', 1],
  ['Green Bay', 'WI', '55009', '0200', 'R20', 1],
  ['Kenosha', 'WI', '55059', '0200', 'R20', 3],     // Kenosha CBSA not primary → Midwest regional
  ...
  // === IOWA ===
  ['Des Moines', 'IA', '19153', '0200', 'R20', 3],  // Des Moines CBSA not primary → Midwest regional
  ['Cedar Rapids', 'IA', '19113', '0200', 'R20', 1], // Cedar Rapids CBSA not primary → Midwest regional
  ['Davenport', 'IA', '19163', '0200', 'R20', 1],   // Davenport CBSA not primary → Midwest regional
  ['Sioux City', 'IA', '19193', '0200', 'R20', 3],
  ['Iowa City', 'IA', '19103', '0200', 'R20', 1],

  // === MISSOURI ===
  ['Kansas City', 'MO', '29095', '0200', 'R20', 3], // Kansas City CBSA not primary → Midwest regional
  ['St. Louis', 'MO', '29510', 'S24B', 'R20', 3],
  ['Springfield', 'MO', '29077', '0200', 'R20', 3], // No CBSA match → Midwest regional
  ['Columbia', 'MO', '29019', '0200', 'R20', 3],    // Columbia CBSA not primary → Midwest regional
  ['Independence', 'MO', '29095', '0200', 'R20', 3], // Kansas City CBSA not primary → Midwest regional

  // === NORTH DAKOTA ===
  ['Fargo', 'ND', '38017', '0200', 'R20', 3],       // Fargo CBSA not primary → Midwest regional
  ['Bismarck', 'ND', '38015', '0200', 'R20', 3],
  ['Grand Forks', 'ND', '38035', '0200', 'R20', 3],
  ['Minot', 'ND', '38101', '0200', 'R20', 3],
  ['West Fargo', 'ND', '38017', '0200', 'R20', 3],  // Fargo CBSA not primary → Midwest regional

  // === SOUTH DAKOTA ===
  ['Sioux Falls', 'SD', '46099', '0200', 'R20', 3], // Sioux Falls CBSA not primary → Midwest regional
  ...
  // === NEBRASKA ===
  ['Omaha', 'NE', '31055', '0200', 'R20', 3],       // Omaha CBSA not primary → Midwest regional
  ['Lincoln', 'NE', '31109', '0200', 'R20', 3],
  ['Bellevue', 'NE', '31153', '0200', 'R20', 3],    // Omaha CBSA not primary → Midwest regional
  ['Grand Island', 'NE', '31079', '0200', 'R20', 1],
  ['Kearney', 'NE', '31019', '0200', 'R20', 1],

  // === KANSAS ===
  ['Wichita', 'KS', '20173', '0200', 'R20', 3],     // No CBSA match → Midwest regional
  ['Overland Park', 'KS', '20091', '0200', 'R20', 3], // Kansas City CBSA not primary → Midwest regional
  ['Kansas City', 'KS', '20209', '0200', 'R20', 3],   // Kansas City CBSA not primary → Midwest regional
  ['Olathe', 'KS', '20091', '0200', 'R20', 3],        // Kansas City CBSA not primary → Midwest regional
  ['Topeka', 'KS', '20177', '0200', 'R20', 3],

  // === TEXAS ===
  ['Houston', 'TX', '48201', 'S37B', 'Y44HO', 1],
  ['San Antonio', 'TX', '48029', '0300', 'STX', 1], // San Antonio CBSA not primary → South regional
  ['Dallas', 'TX', '48113', 'S37A', 'STX', 2],
  ['Austin', 'TX', '48453', '0300', 'STX', 1],      // Austin CBSA not primary → South regional
  ...
  ['Vancouver', 'WA', '53011', '0400', 'SWA', 1],   // Portland CBSA not primary → West regional, county gas override → WA state
  ['Bellevue', 'WA', '53033', 'S49D', 'Y48SE', 1],

  // === OREGON ===
  ['Portland', 'OR', '41051', '0400', 'R50', 1],    // Portland CBSA not primary → West regional
  ['Salem', 'OR', '41047', '0400', 'R50', 1],       // No CBSA match → West regional
  ['Eugene', 'OR', '41039', '0400', 'R50', 1],
  ['Gresham', 'OR', '41051', '0400', 'R50', 1],
  ['Hillsboro', 'OR', '41067', '0400', 'R50', 1],

  // === CALIFORNIA ===
  ['Los Angeles', 'CA', '06037', 'S49A', 'Y05LA', 1],
  ['San Diego', 'CA', '06073', 'S49E', 'SCA', 2],
  ['San Jose', 'CA', '06085', '0400', 'SCA', 2],    // San Jose CBSA not primary → West regional
  ['San Francisco', 'CA', '06075', 'S49B', 'Y05SF', 1],
  ['Fresno', 'CA', '06019', '0400', 'SCA', 1],      // No CBSA match → West regional

  // === NEVADA ===
  ['Las Vegas', 'NV', '32003', '0400', 'R50', 3],   // Las Vegas CBSA not primary → West regional
  ['Henderson', 'NV', '32003', '0400', 'R50', 3],
  ['Reno', 'NV', '32031', '0400', 'R50', 1],        // No CBSA match → West regional
  ['North Las Vegas', 'NV', '32003', '0400', 'R50', 3],
  ['Sparks', 'NV', '32031', '0400', 'R50', 1],

  // === ARIZONA ===
  ['Phoenix', 'AZ', '04013', 'S48A', 'R50', 3],
  ['Tucson', 'AZ', '04019', '0400', 'R50', 3],      // Tucson CBSA not primary → West regional
  ...
  // === UTAH ===
  ['Salt Lake City', 'UT', '49035', '0400', 'R40', 1], // Salt Lake CBSA not primary → West regional
  ['West Valley City', 'UT', '49035', '0400', 'R40', 1],
  ['Provo', 'UT', '49049', '0400', 'R40', 1],       // Provo CBSA not primary → West regional
  ['West Jordan', 'UT', '49035', '0400', 'R40', 1],
  ['Orem', 'UT', '49049', '0400', 'R40', 1],        // Provo CBSA not primary → West regional

  // === COLORADO ===
  ['Denver', 'CO', '08031', 'S48B', 'YDEN', 1],
  ['Colorado Springs', 'CO', '08041', '0400', 'SCO', 2], // CO Springs CBSA not primary → West regional, CO state gas
